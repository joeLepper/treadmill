...
_EXPECTED_WORKFLOW_IDS = {
    ...
    "wf-unreferenced-close-report",  # ADR-0075 §4 (added 2026-06-05)
    "wf-fleet-wedge-sweep",  # ADR-0075 §3 v1 (added 2026-06-05)
}
