...
3. `medicoder_events.Consumer.subscribe()` with a malformed sub-name returns a future that terminates immediately — caller discards the future, no log.
